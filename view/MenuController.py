        ...
        self.menus = {
            ...
            "measurement": {
                ...
                "options": {
                    ...
                    MeasurementMenuOptions.MANUAL_VI.value: "Manual V(I) range measurement",
                    MeasurementMenuOptions.MANUAL_IV.value: "Manual I(V) range measurement",
                    MeasurementMenuOptions.AUTOMATIC_VI.value:"Automatic V(I) range measurement",
                    MeasurementMenuOptions.AUTOMATIC_IV.value: "Automatic I(V) range measurement",
                    MeasurementMenuOptions.AUTOMATIC_VT.value: "Automatic V(t) range measurement",
                    MeasurementMenuOptions.AUTOMATIC_IT.value: "Automatic I(t) range measurement",
                }
            },
            "current_scale": {
